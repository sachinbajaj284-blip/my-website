(function(){
  ...
  var SKU_FLOW = {
    ...
    "wellness-session":           { cta:"Pick Your Slot",             href:"", book:true,                   steps:["Payment received for your 1:1 wellness session.","Pick a day and time from Lume Live's calendar below — takes 20 seconds.","Google sends you the confirmation and video-call link straight away."] },
