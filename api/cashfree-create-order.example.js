/*
  Cashfree create-order backend example for Lume Live.

  Do not put CASHFREE_CLIENT_SECRET in any HTML or browser JavaScript.
  Deploy this logic as a server endpoint and point window.LUME_CASHFREE.createOrderEndpoint
  to that endpoint.
...
module.exports = async function handler(req, res){
  ...
  const email = String(customer.email || "hello@lumelive.co.in");
